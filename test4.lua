...
if not ModernV2 then
    ...
    local loaderOk, loaderResult = pcall(function()
        local source = game:HttpGet("https://raw.githubusercontent.com/noelrangga354-ops/Hyunjin/refs/heads/main/src.lua")
    ...
    if loaderOk then
        ...
        local fallbackOk, fallbackResult = pcall(function()
            local source = game:HttpGet("https://raw.githubusercontent.com/noelrangga354-ops/Hyunjin/refs/heads/main/src2.lua")
            local fn, compileErr = loadstring(source)
            if not fn then error(compileErr) end
            return fn()
        end)
